...
<head>
    <meta charset="UTF-8">
    <title>Daftar Akun | Futsal Hub</title>
...
<body
    ...
    <div class="bg-white/95 backdrop-blur-md rounded-[2.5rem] shadow-2xl w-full max-w-md p-10 my-10">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-slate-500 font-medium mt-1">Bergabunglah dengan komunitas FutsalHub</p>
        </div>
        ...
        <form method="POST" action="/register" class="space-y-4">
            ...
            <div>
                <label class="text-[10px] font-black uppercase tracking-[0.15em] text-slate-400 ml-1">Nama
                    Lengkap</label>
