    ...
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden">
            <div class="bg-slate-50/50 px-10 py-8 border-b border-slate-100">
                ...
                <p class="text-slate-500 text-sm mt-3">Daftarkan lapangan baru ke dalam sistem AriFutsal.</p>
            </div>
            ...
            <form action="{{ route('lapangan.store') }}" method="POST" class="p-10 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        <label class="text-xs font-black uppercase tracking-widest text-slate-500 flex items-center gap-2">
                            <i class="fas fa-grass text-emerald-500"></i> Jenis Lapangan
                        </label>
                        <div class="relative">
                            <select name="jenis" required
                                ...
                                <option value="" disabled {{ old('jenis') ? '' : 'selected' }}>Pilih Jenis Lapangan
                                </option>
                                <option value="Rumput Sintetis" {{ old('jenis') == 'Rumput Sintetis' ? 'selected' : '' }}>
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        <div class="flex items-center gap-2 ml-2 mt-3">
                            <span class="flex h-2 w-2 rounded-full bg-emerald-500"></span>
                            <p class="text-[11px] text-slate-400 font-bold italic tracking-wide">
                                Status <span class="text-emerald-600 uppercase">Tersedia</span>
                            </p>
                        </div>
                    </div>
                </div>
