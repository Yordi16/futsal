                            ...
                            <tbody class="divide-y divide-slate-50">
                                ...
                                <tr class="hover:bg-slate-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center text-sm">
                                        <span class="inline-flex items-center gap-1.5 px-3 py-1 text-[9px] font-black uppercase rounded-full 
                                                {{ $j->status_slot == 'tersedia' ? 'bg-emerald-100 text-emerald-700' :
                                                            ($j->status_slot == 'dibooking' ? 'bg-rose-100 text-rose-700' :
                                                                'bg-slate-200 text-slate-600') }}">
                                            <i class="fas {{ $j->status_slot == 'tersedia' ? 'fa-check' :
                                                            ($j->status_slot == 'dibooking' ? 'fa-lock' : 'fa-ban') }}"></i>
                                            {{ $j->status_slot }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4">
