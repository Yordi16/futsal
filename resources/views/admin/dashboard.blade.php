...
@section('content')
    <div class="space-y-10">
        ...
        <a href="{{ route('lapangan.index') }}" class="block">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div
                    ...
                    <div
                        class="bg-indigo-50 p-8 rounded-[2.3rem] flex items-center justify-between overflow-hidden relative">
                        <i
            ...
            <table class="w-full">
                <thead class="bg-slate-50/50 text-slate-400">
                    <tr>
                        ...
                        <th class="px-8 py-5 text-left text-[10px] font-black uppercase tracking-[0.2em]">Tanggal & Waktu
                        </th>
                        <th class="px-8 py-5 text-center text-[10px] font-black uppercase tracking-[0.2em]">Status</th>
                        <th class="px-8 py-5 text-center text-[10px] font-black uppercase tracking-[0.2em]">Detail</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-slate-50">
                    @forelse($bookingTerbaru as $b)
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors group">
                            ...
                            <td class="px-8 py-5 text-sm text-slate-500 font-medium whitespace-nowrap">
                                <div class="flex items-center gap-3">

                                    <div class="flex items-center gap-2">
                                        <i class="far fa-calendar-alt text-indigo-500"></i>
                                        <span class="text-slate-700 font-bold">
                                            {{ \Carbon\Carbon::parse($b->jadwalLapangan->tanggal)->translatedFormat('d M Y') }}
                                        </span>
                                    </div>
                            ...
                            <td class="px-8 py-5 text-center">
                                <a href="{{ route('admin.booking.index', $b->id) }}"
                                    class="inline-flex items-center justify-center w-10 h-10 bg-slate-50 text-slate-400 rounded-xl hover:bg-indigo-50 hover:text-indigo-600 transition-all shadow-sm border border-slate-100 group/btn">
                                    <i
                                        class="fas fa-arrow-right text-xs group-hover/btn:translate-x-0.5 transition-transform"></i>
                                </a>
                            </td>
                        </tr>
                    @empty
